  ...
  return (
    <div className="flex flex-col items-center px-6 md:px-16 lg:px-24 bg-state-50 pt-20 pb-30">
      <Title
        ...
        subTitle="Discover why discerning travelers consistently choose E-commerce Platform for Finding Rooms on Rent for exclusive and luxurious accommodations around the world."
      />
