  ...
  return (
    <div>
      <Title
        ...
        font="outfit"
        title="Dashboard"
        subTitle="Monitor your room listing, track bookings and analyze revenue-all in one place. stay updated with real-time insights to ensure smooth operation."
      />
