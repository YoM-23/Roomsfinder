...
<<<<<<< HEAD
  ...
  return (
    <div className="py-28 md:pb-35 md:pt-32 px-4 md:px-16 lg:px-24 xl:px-32">
      <Title
        title="My Bookings"
        subTitle="Easily manage your past, current, and upcoming room reservations in one place. Plan your trips seamlessly with just a few clicks"
        align="left"
      />
=======
  ...
  return (
    <div className='py-28 md:pb-35 md:pt-32 px-4 md:px-16 lg:px-24 xl:px-32'>
        ...
        <Title title='My Bookings' subTitle='Easily manage your past, current, and upcoming room reservations in one place. Plan your trips seamlessly with just a few clicks' align='left' />
            ...
            <div className='hidden md:grid md:grid-cols-[3fr_2fr_1fr] w-full border-b border-gray-300 font-medium text-base py-3'>
               ...
               <div>Payment</div>
                ...
                {bookings.map((booking, index)=>(
                    <div key={index} className='grid grid-cols-1 md:grid-cols-[3fr_2fr_1fr] w-full border-b border-gray-300 py-6 first:border-t'>
                        {/*----- Home Details -----*/}
                        <div className='flex flex-col md:flex-row'>
                            <img src={booking.room.images[0]} alt="home-img" className='w-full md:w-44 h-32 rounded shadow object-cover'/>   
                            <div className='flex flex-col gap-1.5 max-md:mt-3 md:ml-4'>
                                <p className='font-playfair text-2xl'>{booking.home.name}
          ...
          >
            ...
            <div className="flex flex-col md:flex-row">
              ...
              <div className="flex flex-col gap-1.5 max-md:mt-3 min-md:ml-4">
                ...
                <div className="flex items-center gap-1 text-sm text-gray-500">
                  <img src={assets.locationIcon} alt="location-icon" />
                  <span>{booking.home.address}</span>
                </div>
                <div className="flex items-center gap-1 text-sm text-gray-500">
                  <img src={assets.guestsIcon} alt="guests-icon" />
