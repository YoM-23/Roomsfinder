  ...
  return room && (
    <div className='py-28 md:py-35 px-4 md:px-16 lg:px-24 xl:px-32'>
       ...
       <div className='flex flex-col md:flex-row items-start md:items-center gap-2'>
        <h1 className='text-3x1 md:text-4x1 font-playfair'>{room.hotel.name} <span className='font-inter text-sm'>({room.roomType})</span></h1>
            ...
            <div className='grid grid-cols-2 gap-4 lg:w-1/2 w-full'>
             ...
             <div className='flex flex-col md:flex-row md:justify-between mt-10'>
                <div className='flex flex-col'>
                    <h1 className='text-3x1 md:text-4x1 font-playfair'>Experience Luxury Like Never Before</h1>
             ...
             {/*CheckIN CheckOut Form */}
                <form className='flex flex-col md:flex-row items-start md:items-center justify-between bg-white shadow-[0px_0px_20px_rgba(0,0,0,0.15)] p-6 rounded-xl mx-auto mt-16 max-w-6x1'>
                    ...
                    <div className='flex flex-col flex-wrap md:flex flex-row items-start md:items-center gap-4 md:gap-10 text-gray-500'>
                ...
                <div className='max-w-3x1 border-y border-gray-300 my-15 py-10 text-gray-500'>
                    <p>Guest will be allocated on the ground floor according to availability. You get a comfortable two bed apartment has a true city feeling. The price quoted is for two guest, at the guest slot please remark the number of guests to the to get the exact price for groups.</p>
                </div>
                 ...
                 <div className='flex flex-col items-start gap-4'>
                    <div className='flex gap-4'>
                        ...
                        <div>
                            <p className='text-lg md:text-xl font-playfair'>Hosted by {room.hotel.name}</p>
                    ...
                    <button className='px-6 py-2.5 mt-4 rounded text-white bg-primary hover:bg-primary-dull transition-all cursor-pointer font-playfair'>Contact Now</button>
                 </div>
