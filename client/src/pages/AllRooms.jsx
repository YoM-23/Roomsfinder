...
>>>>>>> ac9f9e132bbf8a30dec436546d3e6ca8fe2aca46
  ...
  //Handler changes for filters and sorting
  ...
  //Function to check if a room matched the selected room types
  ...
  //Function to check if a room matched the selected price ranges
  ...
  const filterDestination = (room) => {
    ...
    return room.home.city.toLowerCase().includes(destination.toLowerCase());
  };
